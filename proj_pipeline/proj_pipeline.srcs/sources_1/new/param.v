...
`define CPU_PARAM
    ...
    //branch    
    `define BRANCH_BEQ  'b0001
    `define BRANCH_BNE  'b0010
    `define BRANCH_BLT  'b0011
    `define BRANCH_BLTU 'b0100
    `define BRANCH_BGE  'b0101
    `define BRANCH_BGEU 'b0110
    `define BRANCH_JAL  'b0111
    `define BRANCH_JALR 'b1000
